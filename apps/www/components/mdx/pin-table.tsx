...
export type PinType = "INPUT" | "OUTPUT" | "BIDIR" | "POWER" | "GND" | "NC";

export interface PinRow {
  /** Pin number or connector label */
  pin: number | string;
  /** Signal name on the pin */
  signal: string;
  /** Pin direction or function type */
  type?: PinType;
  /** Voltage level for the pin */
  voltage?: string;
  /** Alternate function or peripheral mapping */
  altFunction?: string;
  /** Optional human-readable description */
  description?: string;
}

export interface PinTableProps extends React.HTMLAttributes<HTMLDivElement> {
  /** Optional block title */
  title?: string;
  /** Optional connector label, e.g. J1, P1 */
  connector?: string;
  /** Rows defining the pin mapping */
  rows: PinRow[];
...
export const PinTable = React.forwardRef<HTMLDivElement, PinTableProps>(
  ({ title, connector, rows, caption, className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        data-pin-table
